...
cme_ans = np.array([[0.0855, 0.0857, 0.0811],
 [0.0866, 0.0851, 0.0810],
 [0.0844, 0.0833, 0.0791],
 [0.0815, 0.0808, 0.0775],
 [0.0767, 0.0772, 0.0734]])

ice_ans = np.array([[0.0870, 0.0866, 0.0817],
 [0.0807, 0.0835, 0.0806],
 [0.0855, 0.0829, 0.0790],
 [0.0865, 0.0843, 0.0801],
 [0.0713, 0.0754, 0.0718]])
...
futures_all = [[99.9100, 99.9150, 99.9150, 99.9200, 99.9250, 99.9250, 99.9300], 
 [99.9075, 99.9150, 99.9150, 99.9200, 99.9250, 99.9250, 99.9300],
 [99.9075, 99.9150, 99.9150, 99.9250, 99.9250, 99.9250, 99.9300],
 [99.9150, 99.9250, 99.9250, 99.9300, 99.9300, 99.9300, 99.9400],
 [99.9125, 99.9250, 99.9250, 99.9350, 99.9350, 99.9350, 99.9400]]
# https://apps.newyorkfed.org/markets/autorates/SOFR#Chart12
sofr_raw = [0.09, 0.11, 0.10, 0.10, 0.11, \
 0.10, 0.10, 0.10, 0.10, 0.10, \
 0.10, 0.09, 0.09, 0.09, 0.09, \
 0.10, 0.09, 0.07, 0.06]


date_l = ["11/16/2020", "11/17/2020", "11/18/2020", "11/19/2020"]
...
chart_data = pd.DataFrame({
	'date': date_l,
	'CME': cme_ans[:4].T[terms.index(term)],
	'ICE': ice_ans[:4].T[terms.index(term)],
